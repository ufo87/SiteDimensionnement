...
function recuperationInformation()
{
  ...
  var tableauV3V_spherique = [
	...
	if (!debug)
	{
		_puissance = document.getElementById("puissanceCanalisationPuissance").value;
		_pdcMax = document.getElementById("pdcMaxCanalisationPuissance").value;
    _tempEauAller = document.getElementById("temperatureAllerCanalisationPuissance").value;
    _tempEauRetour = document.getElementById("temperatureRetourCanalisationPuissance").value;
    _tauxGlycol = document.getElementById("tauxGlycolCanalisationPuissance").value;
    _pdc_ajoutes = document.getElementById("pdc_ajouteCanalisationPuissance").value;
	}

	save();

	if (checkValidity(_puissance, _pdcMax, _tempEauAller, _tempEauRetour, _tauxGlycol)=="")
    {
		_tempEau = _tempEauAller * 0.5 + _tempEauRetour * 0.5;
		_debit = _puissance / ( 1.163*(_tempEauAller-_tempEauRetour) );
		if (_debit < 0)
			_debit = _debit * -1
        ...
        else
        {
            ...
            document.getElementById('rho').innerHTML = "Masse volumique : " + Math.round(calculMasseVolumiqueEau(_tauxGlycol, _tempEau)) + " kg/m³";
            document.getElementById('rho').innerHTML += '<br>';
            document.getElementById('rho').innerHTML += "Viscosité : " + Math.round(calculViscosite(_tauxGlycol, _tempEau)*100)/100;
			      document.getElementById('rho').innerHTML += '<br>';
            document.getElementById('rho').innerHTML = "Debit : " + Math.round(_debit*10)/10 + " l/h";
            if (checkValidityPdC(_pdc_ajoutes)=="")
            {
                ...
                if (resultatV3V.length!=0)
                {
                    ...
                    {
                        generate_table(resultatV3V, "tableauV3V_spherique", ["Autorité", "PdC V3V", "Kvs", "DN", "Sélection vanne", "Type"]);
                    }
                }
                else
                {
    ...
    else
    {
        ...
        document.getElementById('rho').innerHTML = checkValidity(_puissance, _pdcMax, _tempEauAller, _tempEauRetour, _tauxGlycol);
    }
}
...
function checkValidity(_puissance, _pdcMax, _tempEauAller, _tempEauRetour, tauxGlycol)
{
    if (_puissance==='none' || _puissance==="" || isNaN(_puissance))
        return "La puissance est mal renseignée";
    if (_puissance==0)
        return "La puissance ne peut être nulle";
    if (_puissance<0)
        return "La puissance ne peut être négative";
    ...
    if (_pdcMax<0)
	  ...
	  if (_tempEauAller == _tempEauRetour )
        return "Les températures ne doivent pas être égales";

    if (_tempEauAller===null || _tempEauAller==='none' || _tempEauAller==="" || isNaN(_tempEauAller))
        return "La température aller est mal renseignée";
    if (_tempEauAller>85)
        return "La température aller est trop élevée";
    if (_tempEauAller<-50)
        return "La température aller est trop faible";

	  if (_tempEauRetour===null || _tempEauRetour==='none' || _tempEauRetour==="" || isNaN(_tempEauRetour))
        return "La température retour est mal renseignée";
    if (_tempEauRetour>85)
        return "La température retour est trop élevée";
    if (_tempEauRetour<-50)
        return "La température retour est trop faible";
...
function save()
{
	  localStorage.setItem('temperatureAllerCanalisationPuissance', document.getElementById("temperatureAllerCanalisationPuissance").value);
  	localStorage.setItem('temperatureRetourCanalisationPuissance', document.getElementById("temperatureRetourCanalisationPuissance").value);
  	localStorage.setItem('pdcMaxCanalisationPuissance', document.getElementById("pdcMaxCanalisationPuissance").value);
  	localStorage.setItem('tauxGlycolCanalisationPuissance', document.getElementById("tauxGlycolCanalisationPuissance").value);
  	localStorage.setItem('puissanceCanalisationPuissance', document.getElementById("puissanceCanalisationPuissance").value);
  	localStorage.setItem('pdc_ajouteCanalisationPuissance', document.getElementById("pdc_ajouteCanalisationPuissance").value);
}

function load()
{
  	if(localStorage.hasOwnProperty("temperatureAllerCanalisationPuissance"))
  		document.getElementById("temperatureAllerCanalisationPuissance").value = localStorage.getItem("temperatureAllerCanalisationPuissance");
  	else
  		document.getElementById("temperatureAllerCanalisationPuissance").value = 40;

    if(localStorage.hasOwnProperty("temperatureRetourCanalisationPuissance"))
  		document.getElementById("temperatureRetourCanalisationPuissance").value = localStorage.getItem("temperatureRetourCanalisationPuissance");
  	else
  		document.getElementById("temperatureRetourCanalisationPuissance").value = 30;

  	if(localStorage.hasOwnProperty("pdcMaxCanalisationPuissance"))
  		document.getElementById("pdcMaxCanalisationPuissance").value = localStorage.getItem("pdcMaxCanalisationPuissance");
  	else
  		document.getElementById("pdcMaxCanalisationPuissance").value = 20;

  	if(localStorage.hasOwnProperty("tauxGlycolCanalisationPuissance"))
  		document.getElementById("tauxGlycolCanalisationPuissance").value = localStorage.getItem("tauxGlycolCanalisationPuissance");
  	else
  		document.getElementById("tauxGlycolCanalisationPuissance").value = 0;

    if(localStorage.hasOwnProperty("puissanceCanalisationPuissance"))
  		document.getElementById("puissanceCanalisationPuissance").value = localStorage.getItem("puissanceCanalisationPuissance");
  	else
  		document.getElementById("puissanceCanalisationPuissance").value = 10000;

    if(localStorage.hasOwnProperty("pdc_ajouteCanalisationPuissance"))
      document.getElementById("pdc_ajouteCanalisationPuissance").value = localStorage.getItem("pdc_ajouteCanalisationPuissance");
    else
      document.getElementById("pdc_ajouteCanalisationPuissance").value = 10;
